                                        ...
                                        <div class="delivery-info">
                                            ...
                                            <span class="delivery-time">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <c:out value="${sm.deliveryDaysMin}"/>-<c:out
                                                            value="${sm.deliveryDaysMax}"/> ngày làm việc
                                                    </c:otherwise>
                                                </c:choose>
                                            </span>
                                        </div>
                        ...
                        <div class="section-card">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="recipientName"
                                           value="${selectedAddress != null && not empty selectedAddress.recipientName ? selectedAddress.recipientName : currentUser.username}"
                                           required>
                                </div>
                                <div class="form-group">
                                    <label for="phone">Số điện thoại<span class="required">*</span></label>
                                    <input type="text" id="phone"
                                           value="${selectedAddress != null ? selectedAddress.phone : ''}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="line1"
                                       value="${selectedAddress != null ? selectedAddress.line1 : ''}" required>
                            </div>

                            <div class="form-group">
                                <label for="line2">Địa chỉ bổ sung</label>
                                <input type="text" id="line2"
                                       value="${selectedAddress != null ? selectedAddress.line2 : ''}">
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="city"
                                           value="${selectedAddress != null ? selectedAddress.city : ''}" required>
                                </div>
                                <div class="form-group">
                                    <label for="province">Tỉnh thành</label>
                                    <input type="text" id="province"
                                           value="${selectedAddress != null ? selectedAddress.province : ''}">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="postalCode"
                                           value="${selectedAddress != null ? selectedAddress.postalCode : ''}">
                                </div>
                                <div class="form-group">
                                    <label for="country">Quốc gia<span class="required">*</span></label>
                                    <input type="text" id="country"
                                           value="${selectedAddress != null ? selectedAddress.country : ''}" required>
                                </div>
                            </div>
                                ...
                                <div class="layout">
                                    <div class="payment-form">
                                            ...
                                            <div class="options">
                                                <label class="option hidden">
                                                    <span class="label-text">
                                                        <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/brand-logos/visa.svg"
                                                             class="icon-sm" alt="Visa"/>
                                                        <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/brand-logos/mastercard.svg"
                                                             class="icon-sm" alt="Mastercard"/>
                                                        <span class="text-sm">Thẻ (demo UI)</span>
                                                    </span>
                                                    <input type="radio" name="pay-method" id="pm-card" value="card"
                                                           class="radio">
                                                </label>

                                                <label class="option">
                                                    <span class="label-text">
                                                        <img src="${env}/images/Bank/VNPay.png" class="icon-sm"
                                                             alt="VNPay"/>
                                                        <span class="text-sm">VNPay</span>
                                                    </span>
                                                    <input type="radio" name="pay-method" id="pm-vnpay" value="vnpay"
                                                           class="radio">
                                                </label>
                                                    ...
                                                    <span class="label-text">
                                                        <svg class="icon-sm" xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                  stroke-width="2"
                                                                  d="M3 10h18M5 6h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2m3 8h8"/>
                                                        </svg>
                                        ...
                                        <div id="card-fields" class="fields-grid hidden">
                                            <div class="field">
                                                ...
                                                <input type="text" id="full_name" class="input"
                                                       value="${currentUser.username}" placeholder="NGUYEN VAN A">
                                            </div>
                                            <div class="field">
                                        ...
                                        <div id="vnpay-fields" class="fields-grid hidden">
                                            ...
                                            <div class="field">
                                                <label for="payment-language" class="label">Ngôn ngữ cổng thanh
                                                    toán</label>
                                        ...
                                        <div class="checkbox-group">
                                            ...
                                            <label for="terms">
                                                Tôi đã đọc và đồng ý với <a href="${env}/terms" class="link">Điều khoản
                                                và Điều kiện</a>
                                            </label>
                                        </div>
                                ...
                                <c:forEach var="item" items="${cart.items}">
                                    <div class="order-item">
                                        ...
                                        <div class="item-details">
                                            <h3 class="item-name">
                                                <a href="${env}/product-detail?id=${item.productId}"
