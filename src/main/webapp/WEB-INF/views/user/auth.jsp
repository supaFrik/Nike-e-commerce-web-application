...
<body>
    ...
    <div
            id="authInit"
            hidden
            data-server-login-error="${fn:escapeXml(loginError)}"
            data-signup-error="${fn:escapeXml(signupError)}"
            data-signup-success="${fn:escapeXml(signupSuccess)}"
            data-open-sign-up="${usernameHasError or emailHasError or passwordHasError or confirmPasswordHasError}"
            data-signup-password-error="${fn:escapeXml(signUpPasswordErrorMessage)}">
    </div>
        ...
        <div class="auth-form-section" role="region" aria-labelledby="auth-header-title">
            ...
            <form class="auth-form form-toggle active" id="signInForm" method="post" action="${pageContext.request.contextPath}/login">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-input" id="signInEmail" name="email" placeholder="Địa chỉ email" required autocomplete="email">
                ...
                <div class="form-group">
                    ...
                    <div class="password-container">
                        ...
                        <button type="button" class="password-toggle" data-target-input="signInPassword" aria-label="Toggle password visibility" aria-pressed="false">
                ...
                <div class="forgot-password">
                    <a href="#" data-forgot-password aria-describedby="forgot-password-desc">Quên mật khẩu?</a>
                ...
                <div class="social-login" role="group" aria-labelledby="social-signin-title">
                    ...
                    <a href="#" class="social-btn" data-social-provider="facebook" aria-label="Đăng nhập với Facebook" aria-describedby="facebook-signin-desc">
                    ...
                    <a href="${pageContext.request.contextPath}/oauth2/authorization/google" class="social-btn" data-social-provider="google" aria-label="Đăng nhập với Google" aria-describedby="google-signin-desc">
                    ...
                    <a href="#" class="social-btn" data-social-provider="apple" aria-label="Đăng nhập với Apple" aria-describedby="apple-signin-desc">
            ...
            <form class="auth-form form-toggle" id="signUpForm" method="post" action="${env}/signup">
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                <div class="form-group">
                    <label class="form-label" for="signUpName">Tên của bạn</label>
                    <input type="text" name="username" class="form-input" id="signUpName" placeholder="Tên của bạn" value="${signupForm.username}" required autocomplete="name" aria-describedby="signUpNameError">
                    <div id="signUpNameError" class="error-message" role="alert" aria-live="assertive" style="${usernameHasError ? '' : 'display:none;'} color:#d32f2f; margin-top:4px;">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-input" id="signUpEmail" placeholder="Địa chỉ email" value="${signupForm.email}" required autocomplete="email" aria-describedby="signUpEmailError">
                    <div id="signUpEmailError" class="error-message" role="alert" aria-live="assertive" style="${emailHasError ? '' : 'display:none;'} color:#d32f2f; margin-top:4px;">
                ...
                <div class="form-group">
                    ...
                    <div id="signUpPasswordError" class="error-message" role="alert" aria-live="assertive" style="${passwordHasError ? 'display:block;' : 'display:none;'}">
                        <c:if test="${passwordHasError}">
                            ${org.springframework.validation.BindingResult.signupForm.fieldErrors['password'][0].defaultMessage}
                        </c:if>
                    </div>
                    <div class="password-container">
                        ...
                        <button type="button" class="password-toggle" data-target-input="signUpPassword" aria-label="Toggle password visibility" aria-pressed="false">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="cursor: pointer; transition: transform 0.2s ease;">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                            </svg>
                ...
                <div class="form-group">
                    ...
                    <div class="password-container">
                        ...
                        <button type="button" class="password-toggle" data-target-input="signUpConfirmPassword" aria-label="Toggle confirm password visibility" aria-pressed="false">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" style="cursor: pointer; transition: transform 0.2s ease;">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                            </svg>
                ...
                <div class="social-login" role="group" aria-labelledby="social-signup-title">
                    ...
                    <a href="#" class="social-btn" data-social-provider="facebook" aria-label="Đăng ký với Facebook" aria-describedby="facebook-signup-desc">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="#1877F2" aria-hidden="true">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                    </a>
                    ...
                    <a href="${pageContext.request.contextPath}/oauth2/authorization/google" class="social-btn" data-social-provider="google" aria-label="Đăng ký với Google" aria-describedby="google-signup-desc">
                        <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                            <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                            <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
                    ...
                    <a href="#" class="social-btn" data-social-provider="apple" aria-label="Đăng ký với Apple" aria-describedby="apple-signup-desc">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                        </svg>
                    </a>
