...
<section class="hero" aria-label="Hero banner section">
    ...
    <div class="hero-banner-container" role="banner" aria-labelledby="hero-main-title" aria-describedby="hero-description">
        ...
        <div class="hero-subtiles">
            <span id="hero-description" aria-label="Hero subtitle">
                Những điều nhỏ bé tuyệt vời làm cho sự vĩ đại trông thật dễ dàng.
            </span>
        </div>
        <div class="hero-button">
            <a href="${env}/products" aria-label="Mua sản phẩm Nike" role="button">
                <span>
                    Mua ngay
                </span>
            </a>
    ...
    <section class="featured" aria-labelledby="featured-title">
        <div class="featured-container">
            <div class="container">
                <h2 class="section-title" id="featured-title">Nổi bật</h2>
            </div>
            <div class="featured-grid" role="grid" aria-labelledby="featured-title">
                <div class="featured-item" role="gridcell" aria-labelledby="featured-1-title" aria-describedby="featured-1-desc">
                    ...
                    <div class="featured-content">
                        ...
                        <a href="#" class="btn btn-outline" aria-label="Nhận thông báo về Nike Air Superfly" role="button">Nhận thông báo</a>
                    </div>
                </div>
                ...
                <div class="featured-item" role="gridcell" aria-labelledby="featured-2-title" aria-describedby="featured-2-desc">
                    ...
                    <div class="featured-content">
                        ...
                        <a href="${env}/products?category=football" class="btn btn-outline" aria-label="Mua sản phẩm Nike Football" role="button">Mua</a>
                    </div>
                </div>
                ...
                <div class="featured-item" role="gridcell" aria-labelledby="featured-3-title" aria-describedby="featured-3-desc">
                    ...
                    <div class="featured-content">
                        ...
                        <a href="${env}/products?category=tennis" class="btn btn-outline" aria-label="Mua sản phẩm Tennis" role="button">Mua</a>
                    </div>
                </div>
                ...
                <div class="featured-item" role="gridcell" aria-labelledby="featured-4-title" aria-describedby="featured-4-desc">
                    ...
                    <div class="featured-content">
                        ...
                        <a href="${env}/products?category=jordan" class="btn btn-outline" aria-label="Mua trang phục Jordan" role="button">Mua trang phục</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="shop-icons-section" aria-labelledby="shop-icons-title">
        <div class="container">
            <h2 class="section-title" id="shop-icons-title">Mua theo biểu tượng</h2>
    ...
    <section class="shop-running-section" aria-labelledby="shop-running-title">
        <div class="container">
            <h2 class="section-title" id="shop-running-title">Giày chạy bộ</h2>
                                ...
                                <c:forEach var="product" items="${runningSection.products}" varStatus="status">
                                    <div class="running-card" data-category="running-shoes" role="listitem" aria-labelledby="running-${status.index + 1}-title" aria-describedby="running-${status.index + 1}-desc">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <p class="product-price" aria-label="Price: ${cfmt:format(product.price)} Vietnamese Dong">
    ...
    <section class="shop-by-sport-section" aria-labelledby="sport-section-title">
        <div class="container">
            <div class="shop-by-sport-header">
                <h2 class="section-title" id="sport-section-title">Mua theo môn thể thao</h2>
    ...
    <div class="cart-sidebar" id="cartSidebar" role="dialog" aria-labelledby="cart-title" aria-describedby="cart-content-desc">
        ...
        <div class="cart-content" id="cart-content-desc" aria-live="polite">
            <div class="cart-empty" id="cartEmpty" aria-label="Trạng thái giỏ trống">
                <i class="fas fa-shopping-bag" aria-hidden="true"></i>
                <p>Giỏ hàng của bạn đang trống</p>
                <a href="${env}/products" class="btn btn-primary" role="button" aria-label="Mua ngay để thêm sản phẩm vào giỏ hàng">Mua ngay</a>
            </div>
