...
<body>
            ...
            <div class="payment-section">
                ...
                <div class="payment-breakdown">
                    ...
                    <div class="breakdown-row shipping-type">
                        <span class="breakdown-label">Loại vận chuyển</span>
                        <span class="breakdown-value">Khách hàng đã chọn Miễn phí vận chuyển (0₫) khi thanh toán</span>
                    </div>
                    <div class="breakdown-row">
        ...
        <aside class="customer-section">
            ...
            <div class="address-card">
                ...
                <div class="address-details">
                    <p class="address-name">${order.customer.username}</p>
                    <p class="address-text">218 Đường Thornridge, Syracuse,<br>Connecticut 35624<br>Việt Nam</p>
                    <a href="#" class="view-map-link">Xem trên Bản đồ</a>
                </div>
            </div>
            ...
            <div class="contact-card">
                ...
                <div class="contact-list">
                    <a href="mailto:bagus.fikri@mail.com" class="contact-item">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                            <path d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M22 6L12 13L2 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <span>${order.customer.credential != null ? order.customer.credential.email : ''}</span>
                    </a>
                    <a href="tel:+8422789907" class="contact-item">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            ...
            <div class="tags-card">
                ...
                <div class="tags-list">
                    ...
                    <span class="tag">Khách hàng thân thiết</span>
    ...
    <script>
        ...
        function initMap() {
            // Location for Syracuse, Connecticut
