        ...
        <aside class="customer-section">
            ...
            <div class="address-card">
                ...
                <div class="address-details">
                    ...
                    <p class="address-text">${order.customer.address.line1}, ${order.customer.address.line2}, <br>
                                            ${order.customer.address.province}, ${order.customer.address.postalCode}<br></p>
                    <a href="#" class="view-map-link">Check map</a>
                </div>
            </div>
            ...
            <div class="contact-card">
                ...
                <div class="contact-list">
                    ...
                    <a href="$" class="contact-item">
                        ...
                        <span>${order.customer.address.phone}</span>
                    </a>
                </div>
            </div>
